...
const rentRegex = new RegExp(/((?:[1-9][\d,]*[\d])?(?:\s*-\s*[1-9][\d,]*[\d])?\s*(שכר דירה|שכר הדירה|ש&quot;ח|ש"ח|שקל|ש״ח|שח|ש''ח|ש'ח|שכה"ד|שכ"ד|שכ״ד|שכה״ד|שכד|כולל ה-כ-ל|שקלים|לחודש|כולל הכלל|לא כולל|כולל הכל|הסכום הוא|מחיר)(?:[^א-ת]|$)\s*-?\s*(?:[1-9][\d,]*[\d])?)/g);
